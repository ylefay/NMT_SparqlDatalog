...
class ModelTest(tf.test.TestCase):
    ...
    def _assertModelVariableNames(self, expected_var_names, model_var_names, name):
    ...
    def _createTestInferModel(self, m_creator, hparams, sess, init_global_vars=False):
