...
def preprocessing(query):
    # mapping_replace = {'var_': '?', 'brack_open': '{',
    # 'brack_close': '}', 'dbo_':'<https://dbpedia.org/ontology/', 'dbr_':'<https://dbpedia.org/resource/',
    ...
    # 'wildcard': '*', 'sep_dot': '.', 'select': 'SELECT DISTINCT', 'where': 'WHERE', 'ask': 'ASK',
